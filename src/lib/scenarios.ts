...
export const scenarios = [
  ...
  },
  {
    ...
    learnMore: [
        { title: 'Credit Cards for Beginners - NerdWallet', url: 'https://www.youtube.com/watch?v=gGgH5errD-k' },
        { title: 'How to Use Your First Credit Card Responsibly - The Financial Diet', url: 'https://www.youtube.com/watch?v=GHeP1eF1D8c' },
        { title: 'How to Build Credit From Scratch - Graham Stephan', url: 'https://www.youtube.com/watch?v=MLA0A-pC5-g' }
    ]
  },
  {
    ...
    learnMore: [
        { title: 'How to Create a Budget For Beginners - The Financial Diet', url: 'https://www.youtube.com/watch?v=sV4-t0r9P08' },
        { title: 'The 50/30/20 Rule of Budgeting Explained - The Infographics Show', url: 'https://www.youtube.com/watch?v=E53b3L2kzb8' },
        { title: 'Budgeting 101: How to Budget for Beginners - Caleb Hammer', url: 'https://www.youtube.com/watch?v=4w3A4n7j9fY' }
    ]
  },
  {
    ...
    learnMore: [
        { title: 'How to Save for a Big Purchase - Investopedia', url: 'https://www.youtube.com/watch?v=7_hUMT5NfQ8' },
        { title: 'Sinking Funds Explained - The Break', url: 'https://www.youtube.com/watch?v=CgPk8eWvHjM' },
        { title: 'How To Save Money For a Car - Dave Ramsey', url: 'https://www.youtube.com/watch?v=FhOaNFXsuJ8' }
    ]
  },
  {
    ...
    learnMore: [
        { title: '401(k) for Beginners - The Plain Bagel', url: 'https://www.youtube.com/watch?v=B9g-6sP_s-Y' },
        { title: 'What is a 401k? Understand the Basics in 3 minutes - The Financial Diet', url: 'https://www.youtube.com/watch?v=kDIcBWdDUrU' },
        { title: 'Roth vs. Traditional 401(k) - Which Is Better? - Money Guy Show', url: 'https://www.youtube.com/watch?v=qigwvzIDL_4' }
    ]
  }
];
